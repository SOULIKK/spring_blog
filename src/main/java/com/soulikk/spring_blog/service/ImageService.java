...
//    }
    ...
    // s3
    public Image register(String S3) {
        Image saveFile = new Image();
        saveFile.setSaveFileName(S3);
        saveFile.setFilePath(S3);
        imageRepository.save(saveFile);
        return saveFile;
    }
    ...
    @Transactional
    public void updateImage(Long postId, Long imgId) {
        imageRepository.updatePostId(postId, imgId);
    }
}
